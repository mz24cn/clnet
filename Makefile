all:
	...
	g++ -L./providers/NVIDIA/lib -o ./build/OpenCLNet ./build/examples/MNIST_CNN.o ./build/examples/character_RNN.o ./build/examples/image_io.o ./build/examples/main.o ./build/examples/multi_layer_perception.o ./build/examples/reference.o ./build/src/debugger.o ./build/src/device_instance.o ./build/src/kernels.o ./build/src/tensor.o -lOpenCL -lgomp 
