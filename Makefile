all:
	...
	g++ -std=c++1y -m64 -I./include -I./providers/NVIDIA/include -O3 -fopenmp -Wall -c -o ./build/examples/CIFAR_WRN.o ./examples/CIFAR_WRN.cpp
	...
	g++ -L./providers/NVIDIA/lib64 -o ./build/OpenCLNet ./build/examples/MNIST_CNN.o ./build/examples/CIFAR_WRN.o ./build/examples/character_RNN.o ./build/examples/image_io.o ./build/examples/main.o ./build/examples/multi_layer_perception.o ./build/examples/reference.o ./build/examples/kernel_test.o ./build/src/debugger.o ./build/src/device_instance.o ./build/src/kernels.o ./build/src/tensor.o -lOpenCL -lgomp -lpthread 

static: all
	ar -r ./build/libOpenCLNet.a ./build/examples/MNIST_CNN.o ./build/examples/CIFAR_WRN.o ./build/examples/character_RNN.o ./build/examples/image_io.o ./build/examples/kernel_test.o ./build/examples/main.o ./build/examples/multi_layer_perception.o ./build/examples/reference.o ./build/src/debugger.o ./build/src/device_instance.o ./build/src/kernels.o ./build/src/tensor.o 
